    ...
    plugins: [
        ...
        copy({
            targets: [
                ...
                { src: ['archives', 'images', 'index.html', 'manifest.webmanifest', 'package.json', 'LICENSE', 'CHANGELOG.md', 'README.md', '*.appxmanifest', '*.pfx', '*.cjs', 'Package.StoreAssociation.xml'], dest: 'dist' }
            ],
            flatten: true
        })
    ]
