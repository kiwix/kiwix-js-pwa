...
* UPDATE: Packaged archive updated to `mdwiki_en_all[-app]_maxi_2025-11.zim`
...
* UPDATE: Packaged archive updated to `wikipedia_en_medicine_maxi_2025-08.zim`
* UPDATE: Support transforming ActionParse ZIMs to mobile style and section handling
...
* REGRESSION: Fix catastrophic backtracking in cleanup regex
...
* DEV: Add Workflow option to build only nsis-web and macOS packages for troubleshooting
...
* UPDATE: Packaged archive updated to `mdwiki_en_all[-app]_maxi_2024-04.zim`
...
* FIX: Use of standard dark and invert styles with any archive
...
* FIX: (partial) Switching themes no longer attempts to jump back to the article immediately
* REGRESSION: Fix failure to open new windows in UWP app (desktop)
...
* FIX: DarkReader now working properly with Zimit ZIMs using Replay system
...
## Release 2.8.2-WikiMed

* UPDATE: Packaged archive updated to `mdwiki_en_all[-app]_maxi_2023-12.zim`
...
* ENHANCEMENT: Auto-dismiss (fade out) active content warnings on scroll
...
* ENHANCEMENT: The base app (not UWP) can now be installed as a PWA (visit <https://kiwix.github.io/kiwix-js-pwa/www/index.html> to try)
...
* ENHANCEMENT: App can now be compiled with Electron or NWJS to support Win XP/7/8.1 (see [releases](https://github.com/kiwix/kiwix-js-pwa/releases))
