...
# Release 3.8.1 / 3.8.2-Wikivoyage

* ENHANCEMENT: Support new Wikimedia ZIM-provided auto dark/light theming system (SW mode only)
...
# Release 3.7.3 / 3.7.4-Wikivoyage
...
* DEV: Update libzim libraries to v0.7
...
* DEV: Update build script to use Windows PowerShell instead of PS Core (unsupported by Electron Builder)
...
## Release 3.3.5 / 3.3.6-Wikivoyage

* UPDATE: Packaged archive updated to `wikivoyage_en_all_maxi_2024-06`
* UPDATE: Title tip info about Origin Private File System
...
## Release 3.2.7 / 3.2.8-Wikivoyage
