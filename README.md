...
Demos:&emsp;[&ensp;[Instal the PWA on Desktop](screenshots/Install-PWA.md)&ensp;]&emsp;[&ensp;[Install PWA and use OPFS on Android](screenshots/Demo-OPFS_Chrome_Android.gif)&ensp;]&emsp;[&ensp;[Picking a folder of archives](screenshots/Folder-Picking.md)&ensp;]&emsp;[&ensp;[Install PWA on Firefox Android](screenshots/Install-PWA_Firefox_Android.gif)&ensp;]&emsp;[&ensp;[Adding app to Edge sidebar](screenshots/Add-KiwixPWA-to-Edge-sidebar.md)&ensp;]
