...
const precacheFiles = [
    ...
    'www/css/all.min.css',
    'www/webfonts/fa-brands-400.woff2',
    'www/webfonts/fa-regular-400.woff2',
    'www/webfonts/fa-solid-900.woff2',
    ...
    'www/js/bundle.js',
    'www/js/init.js',
    'www/js/darkreader.min.js', // Don't move this or below to prevent them being deleted by the build process
    'www/js/webpHeroBundle_0.0.2.js',
    'www/js/katex/katex.min.js',
    'www/js/katex/katex.min.css',
    'www/js/katex/contrib/auto-render.min.js',
    'www/js/katex/contrib/copy-tex.min.js',
    'www/js/katex/contrib/mathtex-script-type.min.js',
    'www/js/katex/contrib/mhchem.min.js',
    'www/js/katex/contrib/render-a11y-string.min.js',
