...
params['packagedFile'] = getSetting('packagedFile') || "mdwiki_en_all_maxi_2022-12.zim"; //For packaged Kiwix JS (e.g. with Wikivoyage file), set this to the filename (for split files, give the first chunk *.zimaa) and place file(s) in default storage
params['archivePath'] = "archives"; //The directory containing the packaged archive(s) (relative to app's root directory)  
params['fileVersion'] = getSetting('fileVersion') || "mdwiki_en_all_maxi_2022-12.zim (4 December 2022)"; //This will be displayed in the app - optionally include date of ZIM file
