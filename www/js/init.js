...
params['appVersion'] = '3.8.8'; // DEV: Manually update this version when there is a new release: it is compared to the Settings Store "appVersion" in order to show first-time info, and the cookie is updated in app.js
...
params['macLegacyElectronVersion'] = '26.6'; // KEEP UP TO DATE!!! This is the last minor version to support macOS 10.13/10.14. Auto-update is embargoed for values starting with this.
