...
var params = {};
params['version'] = "0.9.9.94 WikiMed Beta-dev"; //DEV: do not set this dynamically -- it is compared to the cookie "version" in order to show first-time info, and the cookie is updated in app.js
...
params['fileVersion'] = "wikipedia_en_medicine_novid_2019-08 (6-Aug-2019)"; //Use generic name for actual file, and give version here
