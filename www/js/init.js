...
params['appVersion'] = '3.5.6-Wikivoyage'; // DEV: Manually update this version when there is a new release: it is compared to the Settings Store "appVersion" in order to show first-time info, and the cookie is updated in app.js
// ******* UPDATE THIS ^^^^^^ IN service worker AND PWA-SERVER BELOW !! ********************
params['packagedFile'] = getSetting('packagedFile') || 'wikivoyage_en_all_maxi_2025-02.zim'; // For packaged Kiwix JS (e.g. with Wikivoyage file), set this to the filename (for split files, give the first chunk *.zimaa) and place file(s) in default storage
params['archivePath'] = 'archives'; // The directory containing the packaged archive(s) (relative to app's root directory)
params['fileVersion'] = getSetting('fileVersion') || 'wikivoyage_en_all_maxi_2025-02 (11 February 2025)'; // This will be displayed in the app - optionally include date of ZIM file
...
params['kiwixDownloadServer'] = 'https://download.kiwix.org/zim/wikivoyage/'; // Include final slash
params['kiwixDownloadMirrors'] = ['https://ftp.fau.de/kiwix/zim/wikivoyage/', 'https://mirrors.dotsrc.org/kiwix/zim/wikivoyage/', 'https://www.mirrorservice.org/sites/download.kiwix.org/zim/wikivoyage/', 'https://md.mirrors.hacktegic.com/kiwix-md/zim/wikivoyage/', 'https://library.kiwix.org'];
params['kiwixhiddenDownloadServer'] = 'https://master.download.kiwix.org/zim/wikivoyage/';
