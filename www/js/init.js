...
'use strict';
var params = {};
params['version'] = "0.9.9.3 Wikivoyage Beta-dev"; //DEV: do not set this dynamically -- it is compared to the cookie "version" in order to show first-time info, and the cookie is updated in app.js
...
params['fileVersion'] = "wikivoyage_en_all_novid_2018-01 (6-Jan-2018)"; //Use generic name for actual file, and give version here
