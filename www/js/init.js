...
var params = {};
params['version'] = "0.9.9.985N WikiMed Beta"; //DEV: Manually update this version when there is a new release: it is compared to the cookie "version" in order to show first-time info, and the cookie is updated in app.js
...
params['fileVersion'] = "wikipedia_en_medicine_maxi_2020-04 (3-Apr-2020)"; //Use generic name for actual file, and give version here
