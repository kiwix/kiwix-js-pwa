...
params['appVersion'] = '2.5.8'; // DEV: Manually update this version when there is a new release: it is compared to the Settings Store "appVersion" in order to show first-time info, and the cookie is updated in app.js
...
params['fileVersion'] = getSetting('fileVersion') || 'wikipedia_en_100_mini_2023-07.zim (3 July 2023)'; // This will be displayed in the app - optionally include date of ZIM file
