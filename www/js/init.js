...
params['version'] = "1.2.4-Wikivoyage"; //DEV: Manually update this version when there is a new release: it is compared to the Settings Store "version" in order to show first-time info, and the cookie is updated in app.js
...
params['fileVersion'] = getSetting('fileVersion') || "wikivoyage_en_all_maxi_2021-04 (6-Apr-2020)"; //This will be displayed in the app - optionally include date of ZIM file
