...
var params = {};
params['version'] = "0.9.9.93 Beta-dev"; //DEV: do not set this dynamically -- it is compared to the cookie "version" in order to show first-time info, and the cookie is updated in app.js
...
params['archivePath'] = ""; //The directory containing the packaged archive(s) (relative to app's root directory)  
