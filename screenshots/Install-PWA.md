...
## 📌 Alternative Installation Method (for browsers without install prompt)
...
gain its own icon and dedicated window. In earlier Firefox, you can bookmark the app and it will still work offline. This should work in
