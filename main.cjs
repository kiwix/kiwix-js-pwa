...
// kiwix/operations#797. It is sent only to Kiwix's own servers, rather than set app-wide with app.userAgentFallback,
// which would also change navigator.userAgent, read by the renderer to detect the runtime [kiwix-js-pwa #986]
