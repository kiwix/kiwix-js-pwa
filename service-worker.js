 ...
 */
const appVersion = '2.2.90-Wikivoyage';
...
self.addEventListener('fetch', function (event) {
    ...
    if (/^file:/i.test(rqUrl) && !(regexpZIMUrlWithNamespace.test(strippedUrl) && /\.zim\//i.test(strippedUrl) || /\??iskiwixasset/.test(rqUrl))) return;
